    ...
    <div class="grid">
        ...
        <div class="panel">
            ...
            <div class="kpis">
                ...
                <div class="kpi"><small>Screw Speed</small><b><?= fmt($latestTricanter['screw_speed'] ?? null, 2) ?></b>
                </div>
                <div class="kpi"><small>Bowl RPM</small><b><?= fmt($latestTricanter['bowl_rpm'] ?? null, 0) ?></b></div>
                <div class="kpi"><small>Screw RPM</small><b><?= fmt($latestTricanter['screw_rpm'] ?? null, 2) ?></b>
                </div>
                <div class="kpi"><small>Impeller</small><b><?= fmt($latestTricanter['impeller'] ?? null, 0) ?></b></div>
                <div class="kpi"><small>Feed Rate</small><b><?= fmt($latestTricanter['feed_rate'] ?? null, 2) ?></b>
                </div>
            ...
            <div class="table">
                <table>
                    ...
                    <?php if (!$tricanter): ?>
                    <tr>
                        <td colspan="12">No tricanter data in selected range.</td>
                    </tr>
                    <?php else: ?>
        ...
        <div class="panel">
            ...
            <div class="kpis">
                <div class="kpi"><small>Latest Amount</small><b><?= fmt($latestSolidWaste['amount'] ?? null, 2) ?></b>
                </div>
            ...
            <div class="table">
                <table>
                    ...
                    <?php if (!$solidWaste): ?>
                    <tr>
                        <td colspan="6">No solid waste data in selected range.</td>
                    </tr>
                    <?php else: ?>
        ...
        <div class="panel nozzle-panel">
            ...
            <div class="table">
                <table>
                    ...
                    <?php if (!$nozzle): ?>
                    <tr>
                        <td colspan="9">No nozzle data in selected range.</td>
                    </tr>
                    <?php else: ?>
