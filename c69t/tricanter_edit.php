...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="input-unit-wrap">
                <input type="number" step="0.01" name="screw_speed" value="<?= h($row["screw_speed"]) ?>"
            ...
            <div class="input-unit-wrap long">
                <input type="number" step="0.01" name="feed_rate" value="<?= h($row["feed_rate"]) ?>"
            ...
            <div class="input-unit-wrap">
                <input type="number" step="0.001" name="pressure" value="<?= h($row["pressure"]) ?>"
